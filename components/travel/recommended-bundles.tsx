...
import { Clock3, DollarSign, Layers3 } from "lucide-react"
...
export function RecommendedBundles({ bundles, onAddBundle }: RecommendedBundlesProps) {
  if (bundles.length === 0) {
    return (
          ...
          >
            <div className="flex items-start justify-between gap-3">
              ...
              <button
                ...
                className="shrink-0 rounded-[0.65rem] bg-[var(--app-brand)] px-2.5 py-1.5 text-xs font-medium text-white"
              >
                一键加入
              </button>
            </div>
